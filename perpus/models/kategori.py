...
class kategori(models.Model): #inherit dari Model -> ini nama class sesuai python
    _name = 'perpus.kategori' #attribut dari class Model (lihat dokumen odoo) Modul.Model  jadi nama tabel (ini nama class/tabel sesuai odoo), jadi kalau akses data berdasarkan nama ini
    description = 'class untuk mencatat kategori buku'
    ...
    _sql_constraints = [('name_unik', 'unique(name)', _('Kategori must be unique!'))]
